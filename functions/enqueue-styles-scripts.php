...
function bearsmith_enqueue_styles_and_scripts() {
    // Register and noConflict jQuery 3.5.1
    ...
    wp_enqueue_script( 'custom-plugins', get_stylesheet_directory_uri() . '/js/plugins.js', array( 'jquery.3.5.1' ), $script_last_updated_at, true );
